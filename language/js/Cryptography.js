...
//window.Cryptography.encryptData('a')
//window.Cryptography.encryptData('70d7743aec4c2c0d')
window.Cryptography = (function (window) {
    var _encryptOperation = function () { };
    _encryptOperation.prototype = (function () {
        var self = this;
        var key = stringToHex('key123','useridk', 1, 0));//加密key
        ...
        return {
            ...
            /// s     待解密的字符串
            /// k     密钥
            decryptData: function (s) {
                if (!s || s.length == 0) return "";
                return des(key, HexTostring(s), 0, 0);
            }
        };
    })();
    return new _encryptOperation();
})(window);
